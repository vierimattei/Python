...
namespace dolfin
{
  class dolfin_expression_cd78800bdd0ec420b9af3eeda00d4a13 : public Expression
  {
     public:
       double a;
double ms;
...
double eps;
       ...
       dolfin_expression_cd78800bdd0ec420b9af3eeda00d4a13()
       {
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_cd78800bdd0ec420b9af3eeda00d4a13()
{
  return new dolfin::dolfin_expression_cd78800bdd0ec420b9af3eeda00d4a13;
}
