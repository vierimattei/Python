...
namespace dolfin
{
  class dolfin_expression_2bcfa5aa854ef7256d51db285126500f : public Expression
  {
     public:
       double a;
double ms;
...
double eps;
       ...
       dolfin_expression_2bcfa5aa854ef7256d51db285126500f()
       {
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_2bcfa5aa854ef7256d51db285126500f()
{
  return new dolfin::dolfin_expression_2bcfa5aa854ef7256d51db285126500f;
}
