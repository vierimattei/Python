...
namespace dolfin
{
  class dolfin_expression_be2dad7608144d8a3a6b6494656cdd5c : public Expression
  {
     public:
       double a0;
double ms;
...
double marmar;
       ...
       dolfin_expression_be2dad7608144d8a3a6b6494656cdd5c()
       {
       ...
       {
          values[0] = a0*4*pi*G*mgb/pow((marmar*sqrt(2*pi)),3)*pow(-(1/2)*((pow(x[1],2) + pow(x[1],2)+ pow(x[1],2))/pow(marmar,2)));
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_be2dad7608144d8a3a6b6494656cdd5c()
{
  return new dolfin::dolfin_expression_be2dad7608144d8a3a6b6494656cdd5c;
}
