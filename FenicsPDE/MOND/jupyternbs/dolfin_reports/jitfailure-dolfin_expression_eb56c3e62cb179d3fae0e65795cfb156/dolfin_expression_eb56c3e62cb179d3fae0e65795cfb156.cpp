...
namespace dolfin
{
  class dolfin_expression_eb56c3e62cb179d3fae0e65795cfb156 : public Expression
  {
     public:
       double a;
double ms;
...
double volume_out;
       ...
       dolfin_expression_eb56c3e62cb179d3fae0e65795cfb156()
       {
       ...
       {
          values[0] = sqrt(G*mgb*a)*1/2*log(pow(x[0],2)+pow(x[1],2)+pow(x[2],2));
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_eb56c3e62cb179d3fae0e65795cfb156()
{
  return new dolfin::dolfin_expression_eb56c3e62cb179d3fae0e65795cfb156;
}
