...
namespace dolfin
{
  class dolfin_expression_92f871292d4d9efda8fc738b7ece601b : public Expression
  {
     public:
       double a0;
double ms;
...
double p;
       ...
       dolfin_expression_92f871292d4d9efda8fc738b7ece601b()
       {
       ...
       {
          values[0] = G*mgb/pow(stand_dev,3)/pow(2*pi,3/2)*a0*exp(-(pow(x[0],2) + pow(x[1],2) + pow(x[2],2))/(2*(pow(stand_dev,2)));
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_92f871292d4d9efda8fc738b7ece601b()
{
  return new dolfin::dolfin_expression_92f871292d4d9efda8fc738b7ece601b;
}
