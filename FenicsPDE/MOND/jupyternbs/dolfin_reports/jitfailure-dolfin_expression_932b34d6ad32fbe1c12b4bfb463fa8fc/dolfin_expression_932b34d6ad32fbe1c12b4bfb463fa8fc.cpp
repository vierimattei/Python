...
namespace dolfin
{
  class dolfin_expression_932b34d6ad32fbe1c12b4bfb463fa8fc : public Expression
  {
     public:
       double a0;
double ms;
...
double p;
       ...
       dolfin_expression_932b34d6ad32fbe1c12b4bfb463fa8fc()
       {
       ...
       {
          values[0] = mgb/pow((stand_dev,3))*a0*exp(-(pow(x[0],2) + pow(x[1],2))/(pow(stand_dev,2)));
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_932b34d6ad32fbe1c12b4bfb463fa8fc()
{
  return new dolfin::dolfin_expression_932b34d6ad32fbe1c12b4bfb463fa8fc;
}
