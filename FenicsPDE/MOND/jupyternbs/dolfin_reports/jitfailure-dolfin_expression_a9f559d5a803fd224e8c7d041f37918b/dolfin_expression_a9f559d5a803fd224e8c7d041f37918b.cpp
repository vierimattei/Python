...
namespace dolfin
{
  class dolfin_expression_a9f559d5a803fd224e8c7d041f37918b : public Expression
  {
     public:
       double a0;
double ms;
...
double sigma;
       ...
       dolfin_expression_a9f559d5a803fd224e8c7d041f37918b()
       {
       ...
       {
          values[0] = a*4*pi*G*1/pow((sigma*sqrt(2*pi)),3)*exp(-1/2*(pow(x[0],2) + pow(x[1],2)+ pow(x[2],2))/pow(sigma,2));
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_a9f559d5a803fd224e8c7d041f37918b()
{
  return new dolfin::dolfin_expression_a9f559d5a803fd224e8c7d041f37918b;
}
